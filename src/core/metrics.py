...
from src.core.preprocess_dataset import GroundTruthDocumentRecord
from src.core.configuration import SearchType, RAGConfiguration
...
class RetrievalMetricsCalculator:
    ...
    @staticmethod
    def generate_configuration_id(search_type: SearchType, rag_config: RAGConfiguration) -> str:
